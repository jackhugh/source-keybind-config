export default `@panorama_debug_overlay_opacity          : 0        : , "a"            : 
...
bot_stop                                 : 0        : , "sv", "cheat", "rep" : bot_stop <1|all> | <not_bomber> | <t> | <ct>
...
buy_stamps                               : cmd      :                  : Temporary solution for Pinion to kick back to community map makers.
buymenu                                  : cmd      :                  : Show or hide main buy menu
buyrandom                                : cmd      :                  : Buy random primary and secondary. Primarily for deathmatch where cost is not an issue.
...
cam_collision                            : 0        : , "a", "server_can_execute", "cl" : When in thirdperson and cam_collision is set to 1, an attempt is made to keep the camera from passing though walls.
...
cash_team_bonus_shorthanded              : 0        : , "nf", "rep", "cl" : 
...
chatwheel_ping                           : cmd      :                  : Creates a ping notification triggered by the chatwheel.
...
cl_avatar_convert_png                    : cmd      :                  : Converts all rgb avatars in the avatars directory to png
cl_avatar_convert_rgb                    : cmd      :                  : Converts all png avatars in the avatars directory to rgb
cl_backspeed                             : 450      : , "cheat", "cl"  : 
cl_bob_lower_amt                         : 5        : , "a", "cl"      : The amount the viewmodel lowers when running
...
cl_buywheel_donate_key                   : 0        : , "a", "cl", "ss" : Set the key to use for donation in the buy menu. 0: Left Control; 1: Left Alt; 2: Left Shift.
...
cl_cmdrate                               : 128      : , "a", "user"    : Max number of command packets sent to server per second
...
cl_crosshair_dynamic_splitalpha_outermod : 1        : , "a", "cl", "ss" : If using cl_crosshairstyle 2, this is the alpha modification that will be used for the OUTER crosshair pips once they've split.
cl_crosshair_dynamic_splitdist           : 11       : , "a", "cl", "ss" : If using cl_crosshairstyle 2, this is the distance that the crosshair pips will split into 2. (default is 7)
...
cl_crosshair_sniper_width                : 2        : , "a", "cl", "ss" : If >1 sniper scope cross lines gain extra width (1 for single-pixel hairline)
cl_crosshair_t                           : 0        : , "a", "cl", "ss" : T style crosshair
cl_crosshairalpha                        : 255      : , "a", "cl", "ss" : 
...
cl_cs_dump_econ_item_stringtable         : cmd      :                  : cl_cs_dump_econ_item_stringtable
...
cl_disable_round_end_report              : 0        : , "a", "cl"      : 
cl_disablefreezecam                      : 1        : , "a", "cl"      : Turn on/off freezecam on client
cl_disablehtmlmotd                       : 0        : , "a", "cl"      : Disable HTML motds.
cl_dm_buyrandomweapons                   : 0        : , "a", "cl"      : Player will automatically receive a random weapon on spawn in deathmatch if this is set to 1 (otherwise, they will receive the 
...
cl_fixedcrosshairgap                     : -4       : , "a", "cl", "ss" : For crosshair style 1: How big to make the gap between the pips in the fixed crosshair
...
cl_http_log_enable                       : 0        : , "norecord", "clientcmd_can_execute", "cl" : Allows sending HTTP log from client main menu.
...
cl_interp_ratio                          : 1        : , "user", "cl"   : Sets the interpolation amount (final amount is cl_interp_ratio / cl_updaterate).
...
cl_join_advertise                        : 2        : , "a", "cl"      : Advertise joinable game in progress to Steam friends, otherwise need a Steam invite (2: all servers, 1: official servers, 0: no
...
cl_matchstats_print_own_data             : cmd      :                  : cl_matchstats_print_own_data RANGENAME
...
cl_observed_bot_crosshair                : 0        : , "a", "cl"      : Control the crosshair shown when observing a bot. 0: Show player crosshair. 1: Show player crosshair only when bot can be taken
...
cl_parachute_autodeploy                  : 1        : , "a", "user", "server_can_execute", "cl", "ss" : Auto-deploy parachute if fall speed exceeds lethal limit
...
cl_ping_fade_deadzone                    : 60       : , "a", "cl"      : Distance from the crosshair over which the ping is completely invisible
cl_ping_fade_distance                    : 300      : , "a", "cl"      : Distance from the crosshair over which the ping fades
...
cl_quest_events_print                    : cmd      :                  : cl_quest_events_print
cl_quest_schedule_print                  : cmd      :                  : cl_quest_schedule_print
...
cl_radar_icon_scale_min                  : 1        : , "a", "cl"      : Sets the minimum icon scale. Valid values are 0.4 to 1.25.
...
cl_radial_radio_tab_0_text_1             : 0        : , "a", "cl"      : 
cl_radial_radio_tab_0_text_2             : 0        : , "a", "cl"      : 
cl_radial_radio_tab_0_text_3             : 0        : , "a", "cl"      : 
cl_radial_radio_tab_0_text_4             : 0        : , "a", "cl"      : 
cl_radial_radio_tab_0_text_5             : 0        : , "a", "cl"      : 
cl_radial_radio_tab_0_text_6             : 0        : , "a", "cl"      : 
cl_radial_radio_tab_0_text_7             : 0        : , "a", "cl"      : 
cl_radial_radio_tab_0_text_8             : 0        : , "a", "cl"      : 
cl_radial_radio_tab_1_text_1             : 0        : , "a", "cl"      : 
cl_radial_radio_tab_1_text_2             : 0        : , "a", "cl"      : 
cl_radial_radio_tab_1_text_3             : 0        : , "a", "cl"      : 
cl_radial_radio_tab_1_text_4             : 0        : , "a", "cl"      : 
cl_radial_radio_tab_1_text_5             : 0        : , "a", "cl"      : 
cl_radial_radio_tab_1_text_6             : 0        : , "a", "cl"      : 
cl_radial_radio_tab_1_text_7             : 0        : , "a", "cl"      : 
cl_radial_radio_tab_1_text_8             : 0        : , "a", "cl"      : 
cl_radial_radio_tab_2_text_1             : 0        : , "a", "cl"      : 
cl_radial_radio_tab_2_text_2             : 0        : , "a", "cl"      : 
cl_radial_radio_tab_2_text_3             : 0        : , "a", "cl"      : 
cl_radial_radio_tab_2_text_4             : 0        : , "a", "cl"      : 
cl_radial_radio_tab_2_text_5             : 0        : , "a", "cl"      : 
cl_radial_radio_tab_2_text_6             : 0        : , "a", "cl"      : 
cl_radial_radio_tab_2_text_7             : 0        : , "a", "cl"      : 
cl_radial_radio_tab_2_text_8             : 0        : , "a", "cl"      : 
cl_radial_radio_version_reset            : 12       : , "a", "cl"      : 
...
cl_remove_all_workshop_maps              : cmd      :                  : Removes all maps from the workshop directory.
...
cl_show_observer_crosshair               : 2        : , "a", "cl"      : Show the crosshair of the player being observed. 0: off 1: friends and party 2: everyone 
-cl_show_team_equipment                  : cmd      :                  : 
+cl_show_team_equipment                  : cmd      :                  : 
...
cl_showhelp                              : 0        : , "a", "cl"      : Set to 0 to not show on-screen help
...
cl_sim_grenade_trajectory                : cmd      :                  : Draw trajectory of the deployed grenade if thrown from this position. Takes an optional parameter for how long the drawn trajec
...
cl_spec_mode                             : 4        : , "a", "user", "server_can_execute", "cl", "ss" : Saves the last viewed spectator mode for use next time we start to spectate
...
cl_viewmodel_shift_left_amt              : 0        : , "a", "cl"      : The amount the viewmodel shifts to the left when shooting accuracy increases.
...
csgo_download_match                      : cmd      :                  : Downloads a match via serial code and starts playback
+csm_rot_x_neg                           : cmd      :                  : 
-csm_rot_x_neg                           : cmd      :                  : 
+csm_rot_x_plus                          : cmd      :                  : 
-csm_rot_x_plus                          : cmd      :                  : 
...
dm_reset_spawns                          : cmd      :                  : 
dm_togglerandomweapons                   : cmd      :                  : Turns random weapons in deathmatch on/off
...
drawoverviewmap                          : cmd      :                  : Draws the overview map
drawradar                                : cmd      :                  : Draws HUD radar
ds_get_newest_subscribed_files           : cmd      :                  : Re-reads web api auth key and subscribed file lists from disk and downloads the latest updates of those files from steam
...
dz_clearteams                            : cmd      :                  : Clear all DZ teams
dz_jointeam                              : cmd      :                  : dz_jointeam team# [userid#|name] - Join DZ team N (0 to leave your team).  Server admins can assign other players to teams.
dz_shuffle_teams                         : cmd      :                  : Shuffle all teams for Danger Zone
dz_spawnselect_choose_hex                : cmd      :                  : 
echo                                     : cmd      :                  : Echo text to console.
econ_build_pinboard_images_from_collection_name : cmd      :                  : Renders and saves images for all models in a collection.
econ_clear_inventory_images              : cmd      :                  : clear the local inventory images (they will regenerate)
...
exojump                                  : cmd      :                  : equips or removes exojump
...
ff_damage_decoy_explosion                : 0        : , "rep", "cl"    : Enables or disables team damage from decoy detonation
...
fps_max_menu                             : 0        :                  : Frame rate limiter, main menu
...
hideoverviewmap                          : cmd      :                  : Hides the overview map
...
host_workshop_collection                 : cmd      :                  : Get the latest version of maps in a workshop collection and host them as a maplist.
...
itemtimedata_dump_active                 : cmd      :                  : 
itemtimedata_dump_total                  : cmd      :                  : 
itemtimedata_print_and_reset             : cmd      :                  : Outputs item time data to server log and clears data.
+jlook                                   : cmd      :                  : 
-jlook                                   : cmd      :                  : 
joy_accelmax                             : 1        : , "a", "cl"      : 
joy_accelscale                           : 4        : , "a", "cl"      : 
...
joy_autoAimDampenMethod                  : 1        : , "a", "cl"      : 
...
joystick                                 : 0        : , "a", "cl"      : True if the joystick is enabled, false otherwise.
...
+klook                                   : cmd      :                  : 
lastinv                                  : cmd      :                  : 
launch_warmup_map                        : cmd      :                  : Launches warmup map
-left                                    : cmd      :                  : 
+left                                    : cmd      :                  : 
...
localization_quest_item_string_printout  : cmd      :                  : localization_quest_item_string_printout
...
m_mousespeed                             : 0        : , "a", "cl"      : Windows mouse acceleration (0 to disable, 1 to enable [Windows 2000: enable initial threshold], 2 to enable secondary threshold
...
mm_dedicated_search_maxping              : 50       : , "a"            : Longest preferred ping to dedicated servers for games
mm_dlc_debugprint                        : cmd      :                  : Shows information about dlc
mm_queue_show_stats                      : cmd      :                  : Display global server stats
...
mp_bot_ai_bt_clear_cache                 : cmd      :                  : Clears the cache for behavior tree files.
...
mp_debug_timeouts                        : cmd      :                  : Prints time outs to the console for debugging
...
mp_guardian_add_bounds_pt                : cmd      :                  : mp_guardian_add_bounds_pt
mp_guardian_add_player_spawn_pt          : cmd      :                  : mp_guardian_add_player_spawn_pt
...
mp_guardian_clear_all_bounds             : cmd      :                  : mp_guardian_clear_all_bounds
mp_guardian_clear_all_player_spawns      : cmd      :                  : mp_guardian_clear_all_player_spawns
mp_guardian_emit_bounds_config           : cmd      :                  : mp_guardian_emit_bounds_config
...
mp_guardian_new_bounds                   : cmd      :                  : mp_guardian_new_bounds
...
mp_guardian_shoot_point                  : cmd      :                  : mp_guardian_shoot_point
...
mp_retake_ct_count                       : 4        : , "rep", "cl"    : Number of CT's when playing retakes.
mp_retake_ct_loadout_bonus_card          : 0        : , "rep", "cl"    : CT bonus card for full buy round when playing bomb site retake.
mp_retake_ct_loadout_bonus_card_availability : 1        : , "rep", "cl"    : CT bonus card availability pattern for full buy round when playing bomb site retake.
mp_retake_ct_loadout_default_pistol_round : 1        : , "rep", "cl"    : CT Loadouts for default pistol round when playing bomb site retake.
mp_retake_ct_loadout_enemy_card          : 0        : , "rep", "cl"    : CT enemy card for full buy round when playing bomb site retake.
mp_retake_ct_loadout_full_buy_round      : 4        : , "rep", "cl"    : CT Loadouts for full buy round when playing bomb site retake.
mp_retake_ct_loadout_light_buy_round     : 3        : , "rep", "cl"    : CT Loadouts for force buy round when playing bomb site retake.
mp_retake_ct_loadout_upgraded_pistol_round : 2        : , "rep", "cl"    : CT Loadouts for upgraded pistol round when playing bomb site retake.
mp_retake_max_consecutive_rounds_same_target_site : 2        : , "rep", "cl"    : Limit the number of consecutive rounds targeting the same site.
mp_retake_t_count                        : 3        : , "rep", "cl"    : Number of terrorists when playing retakes.
mp_retake_t_loadout_bonus_card           : 0        : , "rep", "cl"    : T bonus card for full buy round when playing bomb site retake.
mp_retake_t_loadout_bonus_card_availability : 1        : , "rep", "cl"    : T bonus card availability pattern for full buy round when playing bomb site retake.
mp_retake_t_loadout_default_pistol_round : 0        : , "rep", "cl"    : T Loadouts for default pistol round when playing bomb site retake.
mp_retake_t_loadout_enemy_card           : 0        : , "rep", "cl"    : T enemy card for full buy round when playing bomb site retake.
mp_retake_t_loadout_full_buy_round       : 0        : , "rep", "cl"    : T Loadouts for full buy round when playing bomb site retake.
mp_retake_t_loadout_light_buy_round      : 0        : , "rep", "cl"    : T Loadouts for force buy round when playing bomb site retake.
mp_retake_t_loadout_upgraded_pistol_round : 0        : , "rep", "cl"    : T Loadouts for upgraded pistol round when playing bomb site retake.
...
mp_shorthanded_cash_bonus_ignore_kicked  : 1        : , "rep", "cl"    : Determines whether kicked players are included in the assessment for short-handedness
mp_shorthanded_cash_bonus_round_delay    : 2        : , "rep", "cl"    : number of previous rounds that a team needs to have been shorthanded before they are eligible for the short-handed bonus
...
mp_technical_timeout_duration_s          : 0        : , "sv", "rep", "cl" : How many seconds is a full technical timeout?
mp_technical_timeout_per_team            : 0        : , "sv", "rep", "cl" : How many technical timeouts are there per team?
...
nav_area_bgcolor                         : 798657344.000 : , "sv", "cheat"  : RGBA color to draw as the background color for nav areas while editing.
...
nav_selected_set_border_color            : -828708160.000 : , "sv", "cheat"  : Color used to draw the selected set borders while editing.
nav_selected_set_color                   : 1364357504.000 : , "sv", "cheat"  : Color used to draw the selected set background while editing.
...
net_graphheight                          : 0        : , "a", "cl"      : Height of netgraph panel
...
net_graphpos                             : 2        : , "a", "cl"      : 
net_graphproportionalfont                : 0        : , "a", "cl"      : Determines whether netgraph font is proportional or not
...
player_botdifflast_s                     : 0        : , "a", "cl"      : 
player_competitive_maplist_2v2_9_0_24235B08 : 0        : , "a", "cl"      : 
player_competitive_maplist_8_9_0_452B2DC : 0        : , "a", "cl"      : 
player_debug_print_damage                : 0        : , "sv", "cheat"  : When true, print amount and type of all damage received by player to console.
player_nevershow_communityservermessage  : 1        : , "a", "cl", "ss" : 
player_ping                              : cmd      :                  : Creates a ping notification where the player is looking.
...
player_survival_list_9_0_B               : 0        : , "a", "cl"      : 
player_teamplayedlast                    : 2        : , "a", "cl", "ss" : 
player_wargames_list2_9_0_E04            : 0        : , "a", "cl"      : 
...
r_player_visibility_mode                 : 1        : , "a", "cl"      : 
...
replay_death                             : cmd      :                  : start hltv replay of last death
replay_debug                             : 0        : , "rep"          : 
replay_start                             : cmd      :                  : Start GOTV replay: replay_start <delay> [<player name or index>]
replay_stop                              : cmd      :                  : stop hltv replay
...
safezonex                                : 0        : , "a", "cl"      : The percentage of the screen width that is considered safe from overscan
...
sensitivity                              : 1        : , "a", "cl"      : Mouse sensitivity.
...
spec_cameraman_set_xray                  : cmd      :                  : Client command to change the whether the spectator is using the cameraman's X-ray state, if they are active, or let the spectat
...
spec_goto                                : cmd      :                  : Move spectator to specified origin and eyes to specified pitch yaw.
...
spec_lerpto                              : cmd      :                  : Lerp the spectator camera to specified origin and eyes to specified pitch yaw.
...
spec_player                              : cmd      :                  : Spectate player by index
spec_player_by_accountid                 : cmd      :                  : Spectate player by Steam account ID
spec_player_by_name                      : cmd      :                  : Spectate player by name
spec_pos                                 : cmd      :                  : dump position and angles to the console
spec_prev                                : cmd      :                  : Spectate previous player ( valid values are 3 to 6 )
spec_replay_autostart                    : 0        : , "a", "cl"      : Auto-start Killer Replay when available
...
spec_show_xray                           : 1        : , "a", "cl"      : If set to 1, you can see player outlines and name IDs through walls - who you can see depends on your team and mode
...
survival_check_num_possible_final_zone   : cmd      :                  : print out a number of all possible final zone
...
sv_closecaption                          : 1        : , "rep", "cl"    : Enable server-side close captioning: 0 = disabled; 1 = enabled as text chat; 2 = enabled for all sounds
...
sv_cs_dump_econ_item_stringtable         : cmd      :                  : sv_cs_dump_econ_item_stringtable
sv_cs_player_speed_has_hostage           : 200      : , "rep", "cl"    : 
sv_ct_spawn_on_bombsite                  : -1       : , "sv"           : Force cts to spawn on a bombsite
sv_damage_print_enable                   : 1        : , "sv", "rep"    : 0: no damage print in console. 1: damage print in console on death. 2: damage print in console only at next round restart.
...
sv_disable_radar                         : 0        : , "rep", "cl"    : 0: regular radar; 1: always disabled; 2: disabled in warmup
...
sv_fade_player_visibility_farz           : 0        : , "rep", "cl"    : 
...
sv_load_random_client_names_file         : cmd      :                  : Loads a file containing random name words for clients
...
sv_mapvetopickvote_maps                  : 0        : , "sv"           : Which maps are used for map veto pick sequence
sv_mapvetopickvote_phase_duration        : 0        : , "sv"           : How many seconds each phase lasts
...
sv_rethrow_last_grenade                  : cmd      :                  : Emit the last grenade thrown on the server.
...
test_convar                              : 0        : , "a", "clientcmd_can_execute", "cl" : Skips the prompt when saving a buy favorite in the buy menu
...
test_js_proto                            : cmd      :                  : Run a simple set of tests converting back and forth between JS and Protobuf objects.
...
timeout_ct_start                         : cmd      :                  : 
timeout_terrorist_start                  : cmd      :                  : 
...
trusted_launch                           : 1        : , "a", "cl"      : Trusted launch status
trusted_launch_info                      : cmd      :                  : Present information about trusted launch to console
trusted_launch_once                      : 0        : , "a", "cl"      : Trusted launch shown once
...
tv_time_remaining                        : cmd      :                  : Print remaining tv broadcast time
...
ui_deepstats_radio_heat_figurine         : 0        : , "a", "cl"      : 
ui_deepstats_radio_heat_tab              : 0        : , "a", "cl"      : 
ui_deepstats_radio_heat_team             : 0        : , "a", "cl"      : 
ui_deepstats_toplevel_mode               : 0        : , "a", "cl"      : 
ui_inventorysettings_recently_acknowledged : 0        : , "a", "cl"      : 
ui_lobby_draft_enabled                   : 0        : , "cl"           : 
ui_mainmenu_bkgnd_movie_8C5FB98B         : 0        : , "a", "cl"      : Main menu background movie
ui_nearbylobbies_filter3                 : 0        : , "a", "cl"      : 
ui_news_last_read_link                   : 0        : , "a", "cl"      : 
ui_playsettings_custom_preset            : 0        : , "a", "cl"      : 
...
ui_popup_weaponupdate_version            : 3        : , "a", "cl"      : 
...
ui_show_subscription_alert               : 1        : , "a", "cl"      : 
ui_show_unlock_competitive_alert         : 0        : , "a", "cl"      : 
...
viewmodel_fov                            : 68       : , "a", "cl"      : 
viewmodel_offset_randomize               : 0        : , "cheat", "cl"  : randomly change viewmodel offsets to visualize range
viewmodel_offset_x                       : 2        : , "a", "cl"      : 
viewmodel_offset_y                       : 2        : , "a", "cl"      : 
viewmodel_offset_z                       : -2       : , "a", "cl"      : 
viewmodel_presetpos                      : 0        : , "a", "cl"      : 1:'Desktop', 2:'Couch', 3:'Classic' 
...
voice_scale                              : 0        : , "a"            : Overall volume of voice over IP 0.0-1.0
...
workshop_publish                         : cmd      :                  : Bring up the Workshop Publish dialog.
workshop_start_map                       : cmd      :                  : Sets the first map to load once a workshop collection been hosted. Takes the file id of desired start map as a parameter.
workshop_workbench                       : cmd      :                  : Bring up the Workshop workbench dialog.
...
zoom_sensitivity_ratio_mouse             : 0        : , "a", "cl", "ss" : Additional mouse sensitivity scale factor applied when FOV is zoomed in.`;
